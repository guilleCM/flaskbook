...
def add_message():
    ...
    if form.validate_on_submit():
        ...
        if uploaded_files and uploaded_files[0].filename != '': #si la array que hemos inicializado contiene algo
...
def message(message_id):
    ...
    if form.validate_on_submit() and session.get('username'):
        ...
        return redirect(url_for('feed_app.message', message_id=message_id))
